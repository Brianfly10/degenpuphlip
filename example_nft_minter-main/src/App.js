...
function App() {
  ...
  const [feedback, setFeedback] = useState("Its Dog eat Dog.");
  ...
  const claimNFTs = (_amount) => {
    ...
    setFeedback("Minting your Degen Sanctuary Pup...");
    setClaimingNft(true);
    blockchain.smartContract.methods
      .mint(blockchain.account, _amount)
      .send({
        gasLimit: "285000",
        to: "0x064bD4bf2a3f9C0eF2898D1aCA32237de77558fE",
      ...
      .then((receipt) => {
        setFeedback(
          "Bork, you now own a Degen Sanctuary Pup. go visit Opensea.io to view it."
        );
        setClaimingNft(false);
            ...
            {Number(data.totalSupply) == 5000 ? (
              <>
                ...
                <s.TextDescription style={{ textAlign: "center" }}>
                  ...
                  <a
                    target={"_blank"}
                    href={"https://opensea.io/collection/degensanctuarypups"}
                  >
                    Opensea.io
                  </a>
                </s.TextDescription>
